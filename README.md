...
- [`streams`](https://stream-learn.readthedocs.io/en/latest/streams_guide.html) - containing a data stream generator that allows obtaining both stationary and dynamic distributions in accordance with various types of concept drift (also in the field of a priori probability, i.e. dynamically unbalanced data) and a parser of the standard ARFF file format.
- [`evaluators`](https://stream-learn.readthedocs.io/en/latest/evaluators_guide.html) - containing classes for running experiments on stream data in accordance with the Test-Then-Train and Prequential methodology.
- [`classifiers`](https://stream-learn.readthedocs.io/en/latest/classifiers_guide.html) - containing sample stream classifiers,
- [`ensembles`](https://stream-learn.readthedocs.io/en/latest/ensembles_guide.html) - containing standard hybrid models of stream data classification,
- [`metrics`](https://stream-learn.readthedocs.io/en/latest/metrics_api.html) - containing typical classification quality metrics in data streams.
